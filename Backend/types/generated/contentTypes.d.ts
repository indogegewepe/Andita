...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Word: Schema.Attribute.RichText;
  };
}
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WorkingEnd: Schema.Attribute.Time;
    WorkingStart: Schema.Attribute.Time;
  };
}
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    Pictures: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTextWhatsAppTextWhatsApp
  ...
  info: {
    displayName: 'TextWhatsApp';
    pluralName: 'text-whats-apps';
    singularName: 'text-whats-app';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWhatsAppWhatsApp extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'whats-apps';
    singularName: 'whats-app';
  };
  options: {
    draftAndPublish: true;
  };
